...
static PyObject* _cbson_update_message(PyObject* self, PyObject* args) {
    /* NOTE just using a random number as the request_id */
<<<<<<< HEAD:pymongo/_cbsonmodule.c
    /* in message.py:  update(collection_name, upsert, multi, spec, doc, safe) */
=======
>>>>>>> 9529271690f18cda3974c2d05623d2d4202bdab3:pymongo/_cbsonmodule.c
    int request_id = rand();
    char* collection_name;
    int collection_name_length;
    PyObject* doc;
...
<<<<<<< HEAD:pymongo/_cbsonmodule.c
    ...
    unsigned char safe;
    unsigned char check_keys;  /* update doesn't use this */
    check_keys = 0;
    int options;
...
>>>>>>> 9529271690f18cda3974c2d05623d2d4202bdab3:pymongo/_cbsonmodule.c
    ...
    if (length_location == -1 ||
        ...
        !buffer_write_bytes(buffer,
                            "\x00\x00\x00\x00"
<<<<<<< HEAD:pymongo/_cbsonmodule.c
                            "\xd1\x07\x00\x00"   /* struct.pack("<i", 2001)*/
=======
                            "\xd1\x07\x00\x00"
>>>>>>> 9529271690f18cda3974c2d05623d2d4202bdab3:pymongo/_cbsonmodule.c
                            "\x00\x00\x00\x00",
...
<<<<<<< HEAD:pymongo/_cbsonmodule.c
    ...
    Mongo+Wire+Protocol#MongoWireProtocol-OPUPDATE */
    
    if (!buffer_write_bytes(buffer, (const char*)&options, 4)) {
        buffer_free(buffer);
        return NULL;
    }
    
    if (!write_dict(buffer, spec, check_keys)) {
        buffer_free(buffer);
        return NULL;
    }
